...
2、在页面中引入对应的皮肤文件的CSS，如：<link rel="stylesheet" type="text/css" href="skin/qq/prompt_style.css" /> 
...
4、根据您的需要调用相应的消息函数： 
	...
	icoCls：图标类型。传入的内容为className，具体写法可以参考prompt_style.css中对图标的定义方式。默认为空。
